@push('styles')
    <link rel="stylesheet" href="{{ asset('assets/plugins/css/calendar.css') }}">
@endpush
...
@push('scripts')
    <script src="{{ asset('assets/plugins/calendarObject.js') }}"></script>
    <script src="{{ asset('assets/plugins/calendarApp.js') }}"></script>
@endpush
